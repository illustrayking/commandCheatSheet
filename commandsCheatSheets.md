...
| cd ./path                  | means the path i'm going to go there begins from here, it can help you to write shorten path                                                  | cd ./path                                                                                       | cd ./microsoft/help                                      |
...
| mkdir -p                   | create parent and subdirectories at once                                                                                                      | mkdir -p parentDir/{subDir1,subDir2,subDir3/{subSubDir3.1,subSubDir3.2,subSubDir3.3},subDir4}   | mkdir -p web/{html,css,images/{icons,gif,heros},json}    |
...
| mv                         | use mv or *move* to cut or move a file or directory to another place or renaming file or directory                                            | mv + path + new path or mv + file name + new name                                               | mv ./ss.txt /etc/ or mv ./ss.txt ./index.txt             |
...
| ls --color                 | use to remove highlighted color in list mode                                                                                                  | ls -l --color=none                                                                              | ls --color=none                                          |
| cat                        | using cat, you can print any file content inside terminal                                                                                     | cat `file name`                                                                                 |                                                          |
| cat -n                     | display line number of the file                                                                                                               | cat -n `file_name`                                                                              | cat -n /mnt/h/ff.txt                                     |
| sed                        | using sed you can change part of text with given parameters(very interesting command)                                                         |                                                                                                 |                                                          |
...
| xclip -selection clipboard | pipe output of any command to clipboard                                                                                                       | command | xclip                                                                                 | pwd | xclip or echo 'how are you' | xclip                |
| clip.exe                   | clipboard for `WSL` just like xclip                                                                                                           |                                                                                                 | pwd | clip.exe                                           |
| termux-clipboard-set       | xclip for `termux`                                                                                                                            | command | termux-clipboard-set                                                                  | pwd | termux-clipboard-set                               |
...
| command                | description                                                                                                                              | structure                                     | example                                        |
|------------------------|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|------------------------------------------------|
| sudo                   | sudo means *super user do* what i want                                                                                                  | sudo `<command>`                              | sudo mkdir                                      | 
...
| apt --purge            | use this option whenever you want to remove a package, purging means ask to clear any configuration                                      | sudo apt remove --purge `<package name>` -y   | sudo apt remove --purge vlc -y                 |
...
| commands       | description                                          | structure                      | example                           |
|----------------|------------------------------------------------------|--------------------------------|-----------------------------------|
...
alias is way to create shortcut keywords for any command you want
